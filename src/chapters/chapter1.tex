\section{Mathematical Notation}
	...
	with our definition of a set, consider ``the set of all sets that don't
	...
	has no idea what to do with points in $C$.\footnote{
		...
		then we could just \emph{follow the arrows} and life would be simpler.
	}
...
\section{Proof}
	...
	And, indeed, most of our mathematics to date skips over some steps\footnote{
		There are some projects to prove all of the mathematics directly from
	...
	you'll get better.
	For a detailed guide to writing good proofs, please see Appendix \ref{APPENDIX-proofstyle}.
